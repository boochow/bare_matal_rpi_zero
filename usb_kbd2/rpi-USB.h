...
{--------------------------------------------------------------------------*/
struct __attribute__((__packed__, aligned(1))) UsbDescriptorHeader {
...
{--------------------------------------------------------------------------*/
struct __attribute__((__packed__, aligned(1))) UsbDeviceDescriptor {
...
{--------------------------------------------------------------------------*/
struct __attribute__((__packed__, aligned(1))) UsbConfigurationDescriptor {
	struct UsbDescriptorHeader Header;								// +0x0 Length of this descriptor, +0x1 DEVICE descriptor type (enum DescriptorType)
...
{--------------------------------------------------------------------------*/
struct __attribute__((__packed__, aligned(1))) UsbOtherSpeedConfigurationDescriptor {
	struct UsbDescriptorHeader Header;								// +0x0 Length of this descriptor, +0x1 DEVICE descriptor type (enum DescriptorType)
	uint16_t TotalLength;											// +0x2 Total length of all descriptors for this configuration
	uint8_t InterfaceCount;											// +0x4 Number of interfaces in this configuration
	uint8_t ConfigurationValue;										// +0x5 Value of this configuration (1 based)
...
{--------------------------------------------------------------------------*/
struct __attribute__((__packed__, aligned(1))) UsbInterfaceDescriptor {
	struct UsbDescriptorHeader Header;    							// +0x0 Length of this descriptor, +0x1 DEVICE descriptor type (enum DescriptorType)
...
{--------------------------------------------------------------------------*/
struct __attribute__((__packed__, aligned(1))) UsbEndpointDescriptor {
	struct UsbDescriptorHeader Header;								// +0x0 Length of this descriptor, +0x1 DEVICE descriptor type (enum DescriptorType)
	struct __attribute__((__packed__, aligned(1))) {
		unsigned Number : 4;							// @0
...
{--------------------------------------------------------------------------*/
struct __attribute__((__packed__, aligned(1))) UsbStringDescriptor {
	struct UsbDescriptorHeader Header;								// +0x0 Length of this descriptor, +0x1 DEVICE descriptor type (enum DescriptorType)
...
{--------------------------------------------------------------------------*/
struct __attribute__((__packed__, aligned(1))) HubDescriptor {
	struct UsbDescriptorHeader Header;								// +0x0 Length of this descriptor, +0x1 DEVICE descriptor type (enum DescriptorType)
...
{--------------------------------------------------------------------------*/
struct __attribute__((__packed__, aligned(1))) HubStatus {
	bool LocalPower : 1;								// @0
...
{--------------------------------------------------------------------------*/
struct __attribute__((__packed__, aligned(1))) HubStatusChange {
...
{--------------------------------------------------------------------------*/
struct __attribute__((__packed__, aligned(1))) HubFullStatus {
	union {
		struct __attribute__((__packed__, aligned(1))) {
			union {
...
{--------------------------------------------------------------------------*/
struct __attribute__((__packed__, aligned(1))) HubPortStatus {
	bool Connected : 1;									// @0
	bool Enabled : 1;									// @1
	bool Suspended : 1;									// @2
...
{--------------------------------------------------------------------------*/
struct __attribute__((__packed__, aligned(1))) HubPortStatusChange {
...
{--------------------------------------------------------------------------*/
struct __attribute__((__packed__, aligned(4))) HubPortFullStatus {
	union {
		struct __attribute__((__packed__, aligned(1))) {
			union {
...
struct __attribute__((__packed__)) UsbPipeControl {
	...
	USB_TRANSFER Type : 2;											// @8  Packet type
